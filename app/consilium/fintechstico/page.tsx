...
const Register = () => {
  ...
  const [resumeOrGithub, setresumeOrGithub] = useState('');
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const registrationData = {
      ...
      resume_or_github: resumeOrGithub,
    ...
    try 
    {
        const { error } = await supabase.from('fintechstico').insert([registrationData]);
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="text" placeholder="Resume/Github link/LinkedIn profile" value={resumeOrGithub} onChange={(e) => setresumeOrGithub(e.target.value)} />
